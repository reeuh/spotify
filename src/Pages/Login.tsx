...
const Login = () => {
  return (
    <div className="w-full">
      <div
        id="login"
        className="w-[30rem] h-[33rem] flex flex-col justify-center items-center gap-5 bg-black rounded-2xl px-10 py-16"
      >
        ...
        <a
          href=""
          className="text-sm hover:border-b border-[#1DB954] hover:bg-none hover:text-[#1DB954]"
        >
