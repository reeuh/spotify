...
const Signup = () => {
  return (
    <div id="/signup" className="w-full max-w-[1440px] !mx-auto flex justify-center items-center h-full">
      <div className="w-[30rem] flex flex-col justify-center items-center gap-5 bg-black rounded-2xl px-10 py-12">
